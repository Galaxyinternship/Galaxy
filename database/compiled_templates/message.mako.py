...
_magic_number = 10
_modified_time = 1491279718.127905
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ns = runtime.TemplateNamespace('__anon_0x7fc65c0ebc50', context._clean_inheritance_tokens(), templateuri=u'/refresh_frames.mako', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fc65c0ebc50')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7fc65c0ebc50')._populate(_import_ns, [u'handle_refresh_frames'])
