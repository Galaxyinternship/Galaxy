...
_magic_number = 10
_modified_time = 1491387864.006349
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ns = runtime.TemplateNamespace('__anon_0x7fedbc811250', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fedbc811250')] = ns

    ns = runtime.TemplateNamespace('__anon_0x7fedbc8110d0', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fedbc8110d0')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7fedbc811250')._populate(_import_ns, [u'render_individual_tagging_element', u'render_community_tagging_element', u'community_tag_js'])
        _mako_get_namespace(context, '__anon_0x7fedbc8110d0')._populate(_import_ns, [u'*'])
